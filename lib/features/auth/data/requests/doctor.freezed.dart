...
mixin _$DoctorRegisterRequest {
 ...
 String get phoneNumber; String get email; String get licenseNumber; String get specialization; String get hospital; String? get licenseDocumentUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,nationalId,password,confirmPassword,fullName,phoneNumber,email,licenseNumber,specialization,hospital,licenseDocumentUrl);

@override
String toString() {
  return 'DoctorRegisterRequest(nationalId: $nationalId, password: $password, confirmPassword: $confirmPassword, fullName: $fullName, phoneNumber: $phoneNumber, email: $email, licenseNumber: $licenseNumber, specialization: $specialization, hospital: $hospital, licenseDocumentUrl: $licenseDocumentUrl)';
}
...
@useResult
$Res call({
 String nationalId, String password, String confirmPassword, String fullName, String phoneNumber, String email, String licenseNumber, String specialization, String hospital, String? licenseDocumentUrl
});
...
/// Create a copy of DoctorRegisterRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? nationalId = null,Object? password = null,Object? confirmPassword = null,Object? fullName = null,Object? phoneNumber = null,Object? email = null,Object? licenseNumber = null,Object? specialization = null,Object? hospital = null,Object? licenseDocumentUrl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String nationalId,  String password,  String confirmPassword,  String fullName,  String phoneNumber,  String email,  String licenseNumber,  String specialization,  String hospital,  String? licenseDocumentUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DoctorRegisterRequest() when $default != null:
return $default(_that.nationalId,_that.password,_that.confirmPassword,_that.fullName,_that.phoneNumber,_that.email,_that.licenseNumber,_that.specialization,_that.hospital,_that.licenseDocumentUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String nationalId,  String password,  String confirmPassword,  String fullName,  String phoneNumber,  String email,  String licenseNumber,  String specialization,  String hospital,  String? licenseDocumentUrl)  $default,) {final _that = this;
switch (_that) {
case _DoctorRegisterRequest():
return $default(_that.nationalId,_that.password,_that.confirmPassword,_that.fullName,_that.phoneNumber,_that.email,_that.licenseNumber,_that.specialization,_that.hospital,_that.licenseDocumentUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String nationalId,  String password,  String confirmPassword,  String fullName,  String phoneNumber,  String email,  String licenseNumber,  String specialization,  String hospital,  String? licenseDocumentUrl)?  $default,) {final _that = this;
switch (_that) {
case _DoctorRegisterRequest() when $default != null:
return $default(_that.nationalId,_that.password,_that.confirmPassword,_that.fullName,_that.phoneNumber,_that.email,_that.licenseNumber,_that.specialization,_that.hospital,_that.licenseDocumentUrl);case _:
  return null;
...
class _DoctorRegisterRequest implements DoctorRegisterRequest {
  const _DoctorRegisterRequest({required this.nationalId, required this.password, required this.confirmPassword, required this.fullName, required this.phoneNumber, required this.email, required this.licenseNumber, required this.specialization, required this.hospital, this.licenseDocumentUrl});
...
/// Create a copy of DoctorRegisterRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? nationalId = null,Object? password = null,Object? confirmPassword = null,Object? fullName = null,Object? phoneNumber = null,Object? email = null,Object? licenseNumber = null,Object? specialization = null,Object? hospital = null,Object? licenseDocumentUrl = freezed,}) {
