      ...
      children: [
        ...
        if (widget.userType == UserType.doctor ||
          ...
          Column(
            ...
            children: [
              // Hidden text field for file URL (used for validation if needed)
              Opacity(
                opacity: 0,
                child: SizedBox(
                  height: 0,
                        ...
                        children: [
                          ...
                          Text(
                            _licenseFileName.isEmpty
                                ? localizations.chooseLicense
                                : localizations.changeDocument,
                          ),
                        ],
                      ),
              ),
