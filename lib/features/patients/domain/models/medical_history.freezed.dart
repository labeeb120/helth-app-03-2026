...
// Personal Information
 ...
 String? get emergencyContactRelationship;// Vital Statistics
 BloodType get bloodType; double get weight; double get height; String get emergencyContactName; String get emergencyContactPhone;// Medical Conditions
 List<String>? get allergies; List<String>? get chronicConditions; List<Surgery>? get surgeries; List<String>? get currentMedications; List<String>? get pastMedications;// Surgical History
// Hospitalizations
...
/// Create a copy of MedicalHistory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? patientId = null,Object? patientName = null,Object? dateOfBirth = null,Object? gender = null,Object? phoneNumber = null,Object? email = freezed,Object? address = null,Object? emergencyContactRelationship = freezed,Object? bloodType = null,Object? weight = null,Object? height = null,Object? emergencyContactName = null,Object? emergencyContactPhone = null,Object? allergies = freezed,Object? chronicConditions = freezed,Object? surgeries = freezed,Object? currentMedications = freezed,Object? pastMedications = freezed,Object? hospitalizations = freezed,Object? familyMedicalHistory = freezed,Object? isSmoker = null,Object? cigarettesPerDay = null,Object? isAlcoholConsumer = null,Object? alcoholFrequency = null,Object? usesRecreationalDrugs = null,Object? recreationalDrugsDetails = freezed,Object? exerciseFrequency = null,Object? dietaryPreferences = null,Object? vaccinations = freezed,Object? lastMenstrualPeriod = freezed,Object? isPregnant = freezed,Object? pregnancies = freezed,Object? liveBirths = freezed,Object? mentalHealthConditions = freezed,Object? currentTherapist = freezed,Object? additionalNotes = freezed,Object? lastUpdated = null,Object? createdAt = null,}) {
...
as BloodType,weight: null == weight ? _self.weight : weight // ignore: cast_nullable_to_non_nullable
as double,height: null == height ? _self.height : height // ignore: cast_nullable_to_non_nullable
as double,emergencyContactName: null == emergencyContactName ? _self.emergencyContactName : emergencyContactName // ignore: cast_nullable_to_non_nullable
...
as List<String>?,chronicConditions: freezed == chronicConditions ? _self.chronicConditions : chronicConditions // ignore: cast_nullable_to_non_nullable
as List<String>?,surgeries: freezed == surgeries ? _self.surgeries : surgeries // ignore: cast_nullable_to_non_nullable
as List<Surgery>?,currentMedications: freezed == currentMedications ? _self.currentMedications : currentMedications // ignore: cast_nullable_to_non_nullable
...
as List<String>?,hospitalizations: freezed == hospitalizations ? _self.hospitalizations : hospitalizations // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String patientId,  String patientName,  DateTime dateOfBirth,  Gender gender,  String phoneNumber,  String? email,  String address,  String? emergencyContactRelationship,  BloodType bloodType,  double weight,  double height,  String emergencyContactName,  String emergencyContactPhone,  List<String>? allergies,  List<String>? chronicConditions,  List<Surgery>? surgeries,  List<String>? currentMedications,  List<String>? pastMedications,  List<Hospitalization>? hospitalizations,  Map<String, String>? familyMedicalHistory,  bool isSmoker,  int cigarettesPerDay,  bool isAlcoholConsumer,  String alcoholFrequency,  bool usesRecreationalDrugs,  String? recreationalDrugsDetails,  String exerciseFrequency,  String dietaryPreferences,  List<Vaccination>? vaccinations,  DateTime? lastMenstrualPeriod,  bool? isPregnant,  int? pregnancies,  int? liveBirths,  List<String>? mentalHealthConditions,  String? currentTherapist,  String? additionalNotes,  DateTime lastUpdated,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MedicalHistory() when $default != null:
return $default(_that.id,_that.patientId,_that.patientName,_that.dateOfBirth,_that.gender,_that.phoneNumber,_that.email,_that.address,_that.emergencyContactRelationship,_that.bloodType,_that.weight,_that.height,_that.emergencyContactName,_that.emergencyContactPhone,_that.allergies,_that.chronicConditions,_that.surgeries,_that.currentMedications,_that.pastMedications,_that.hospitalizations,_that.familyMedicalHistory,_that.isSmoker,_that.cigarettesPerDay,_that.isAlcoholConsumer,_that.alcoholFrequency,_that.usesRecreationalDrugs,_that.recreationalDrugsDetails,_that.exerciseFrequency,_that.dietaryPreferences,_that.vaccinations,_that.lastMenstrualPeriod,_that.isPregnant,_that.pregnancies,_that.liveBirths,_that.mentalHealthConditions,_that.currentTherapist,_that.additionalNotes,_that.lastUpdated,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String patientId,  String patientName,  DateTime dateOfBirth,  Gender gender,  String phoneNumber,  String? email,  String address,  String? emergencyContactRelationship,  BloodType bloodType,  double weight,  double height,  String emergencyContactName,  String emergencyContactPhone,  List<String>? allergies,  List<String>? chronicConditions,  List<Surgery>? surgeries,  List<String>? currentMedications,  List<String>? pastMedications,  List<Hospitalization>? hospitalizations,  Map<String, String>? familyMedicalHistory,  bool isSmoker,  int cigarettesPerDay,  bool isAlcoholConsumer,  String alcoholFrequency,  bool usesRecreationalDrugs,  String? recreationalDrugsDetails,  String exerciseFrequency,  String dietaryPreferences,  List<Vaccination>? vaccinations,  DateTime? lastMenstrualPeriod,  bool? isPregnant,  int? pregnancies,  int? liveBirths,  List<String>? mentalHealthConditions,  String? currentTherapist,  String? additionalNotes,  DateTime lastUpdated,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _MedicalHistory():
return $default(_that.id,_that.patientId,_that.patientName,_that.dateOfBirth,_that.gender,_that.phoneNumber,_that.email,_that.address,_that.emergencyContactRelationship,_that.bloodType,_that.weight,_that.height,_that.emergencyContactName,_that.emergencyContactPhone,_that.allergies,_that.chronicConditions,_that.surgeries,_that.currentMedications,_that.pastMedications,_that.hospitalizations,_that.familyMedicalHistory,_that.isSmoker,_that.cigarettesPerDay,_that.isAlcoholConsumer,_that.alcoholFrequency,_that.usesRecreationalDrugs,_that.recreationalDrugsDetails,_that.exerciseFrequency,_that.dietaryPreferences,_that.vaccinations,_that.lastMenstrualPeriod,_that.isPregnant,_that.pregnancies,_that.liveBirths,_that.mentalHealthConditions,_that.currentTherapist,_that.additionalNotes,_that.lastUpdated,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String patientId,  String patientName,  DateTime dateOfBirth,  Gender gender,  String phoneNumber,  String? email,  String address,  String? emergencyContactRelationship,  BloodType bloodType,  double weight,  double height,  String emergencyContactName,  String emergencyContactPhone,  List<String>? allergies,  List<String>? chronicConditions,  List<Surgery>? surgeries,  List<String>? currentMedications,  List<String>? pastMedications,  List<Hospitalization>? hospitalizations,  Map<String, String>? familyMedicalHistory,  bool isSmoker,  int cigarettesPerDay,  bool isAlcoholConsumer,  String alcoholFrequency,  bool usesRecreationalDrugs,  String? recreationalDrugsDetails,  String exerciseFrequency,  String dietaryPreferences,  List<Vaccination>? vaccinations,  DateTime? lastMenstrualPeriod,  bool? isPregnant,  int? pregnancies,  int? liveBirths,  List<String>? mentalHealthConditions,  String? currentTherapist,  String? additionalNotes,  DateTime lastUpdated,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _MedicalHistory() when $default != null:
return $default(_that.id,_that.patientId,_that.patientName,_that.dateOfBirth,_that.gender,_that.phoneNumber,_that.email,_that.address,_that.emergencyContactRelationship,_that.bloodType,_that.weight,_that.height,_that.emergencyContactName,_that.emergencyContactPhone,_that.allergies,_that.chronicConditions,_that.surgeries,_that.currentMedications,_that.pastMedications,_that.hospitalizations,_that.familyMedicalHistory,_that.isSmoker,_that.cigarettesPerDay,_that.isAlcoholConsumer,_that.alcoholFrequency,_that.usesRecreationalDrugs,_that.recreationalDrugsDetails,_that.exerciseFrequency,_that.dietaryPreferences,_that.vaccinations,_that.lastMenstrualPeriod,_that.isPregnant,_that.pregnancies,_that.liveBirths,_that.mentalHealthConditions,_that.currentTherapist,_that.additionalNotes,_that.lastUpdated,_that.createdAt);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MedicalHistory&&(identical(other.id, id) || other.id == id)&&(identical(other.patientId, patientId) || other.patientId == patientId)&&(identical(other.patientName, patientName) || other.patientName == patientName)&&(identical(other.dateOfBirth, dateOfBirth) || other.dateOfBirth == dateOfBirth)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.phoneNumber, phoneNumber) || other.phoneNumber == phoneNumber)&&(identical(other.email, email) || other.email == email)&&(identical(other.address, address) || other.address == address)&&(identical(other.emergencyContactRelationship, emergencyContactRelationship) || other.emergencyContactRelationship == emergencyContactRelationship)&&(identical(other.bloodType, bloodType) || other.bloodType == bloodType)&&(identical(other.weight, weight) || other.weight == weight)&&(identical(other.height, height) || other.height == height)&&(identical(other.emergencyContactName, emergencyContactName) || other.emergencyContactName == emergencyContactName)&&(identical(other.emergencyContactPhone, emergencyContactPhone) || other.emergencyContactPhone == emergencyContactPhone)&&const DeepCollectionEquality().equals(other._allergies, _allergies)&&const DeepCollectionEquality().equals(other._chronicConditions, _chronicConditions)&&const DeepCollectionEquality().equals(other._surgeries, _surgeries)&&const DeepCollectionEquality().equals(other._currentMedications, _currentMedications)&&const DeepCollectionEquality().equals(other._pastMedications, _pastMedications)&&const DeepCollectionEquality().equals(other._hospitalizations, _hospitalizations)&&const DeepCollectionEquality().equals(other._familyMedicalHistory, _familyMedicalHistory)&&(identical(other.isSmoker, isSmoker) || other.isSmoker == isSmoker)&&(identical(other.cigarettesPerDay, cigarettesPerDay) || other.cigarettesPerDay == cigarettesPerDay)&&(identical(other.isAlcoholConsumer, isAlcoholConsumer) || other.isAlcoholConsumer == isAlcoholConsumer)&&(identical(other.alcoholFrequency, alcoholFrequency) || other.alcoholFrequency == alcoholFrequency)&&(identical(other.usesRecreationalDrugs, usesRecreationalDrugs) || other.usesRecreationalDrugs == usesRecreationalDrugs)&&(identical(other.recreationalDrugsDetails, recreationalDrugsDetails) || other.recreationalDrugsDetails == recreationalDrugsDetails)&&(identical(other.exerciseFrequency, exerciseFrequency) || other.exerciseFrequency == exerciseFrequency)&&(identical(other.dietaryPreferences, dietaryPreferences) || other.dietaryPreferences == dietaryPreferences)&&const DeepCollectionEquality().equals(other._vaccinations, _vaccinations)&&(identical(other.lastMenstrualPeriod, lastMenstrualPeriod) || other.lastMenstrualPeriod == lastMenstrualPeriod)&&(identical(other.isPregnant, isPregnant) || other.isPregnant == isPregnant)&&(identical(other.pregnancies, pregnancies) || other.pregnancies == pregnancies)&&(identical(other.liveBirths, liveBirths) || other.liveBirths == liveBirths)&&const DeepCollectionEquality().equals(other._mentalHealthConditions, _mentalHealthConditions)&&(identical(other.currentTherapist, currentTherapist) || other.currentTherapist == currentTherapist)&&(identical(other.additionalNotes, additionalNotes) || other.additionalNotes == additionalNotes)&&(identical(other.lastUpdated, lastUpdated) || other.lastUpdated == lastUpdated)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,patientId,patientName,dateOfBirth,gender,phoneNumber,email,address,emergencyContactRelationship,bloodType,weight,height,emergencyContactName,emergencyContactPhone,const DeepCollectionEquality().hash(_allergies),const DeepCollectionEquality().hash(_chronicConditions),const DeepCollectionEquality().hash(_surgeries),const DeepCollectionEquality().hash(_currentMedications),const DeepCollectionEquality().hash(_pastMedications),const DeepCollectionEquality().hash(_hospitalizations),const DeepCollectionEquality().hash(_familyMedicalHistory),isSmoker,cigarettesPerDay,isAlcoholConsumer,alcoholFrequency,usesRecreationalDrugs,recreationalDrugsDetails,exerciseFrequency,dietaryPreferences,const DeepCollectionEquality().hash(_vaccinations),lastMenstrualPeriod,isPregnant,pregnancies,liveBirths,const DeepCollectionEquality().hash(_mentalHealthConditions),currentTherapist,additionalNotes,lastUpdated,createdAt]);
...
as double,emergencyContactName: null == emergencyContactName ? _self.emergencyContactName : emergencyContactName // ignore: cast_nullable_to_non_nullable
as String,emergencyContactPhone: null == emergencyContactPhone ? _self.emergencyContactPhone : emergencyContactPhone // ignore: cast_nullable_to_non_nullable
as String,allergies: freezed == allergies ? _self._allergies : allergies // ignore: cast_nullable_to_non_nullable
as List<String>?,chronicConditions: freezed == chronicConditions ? _self._chronicConditions : chronicConditions // ignore: cast_nullable_to_non_nullable
as List<String>?,surgeries: freezed == surgeries ? _self._surgeries : surgeries // ignore: cast_nullable_to_non_nullable
as List<Surgery>?,currentMedications: freezed == currentMedications ? _self._currentMedications : currentMedications // ignore: cast_nullable_to_non_nullable
...
as List<String>?,hospitalizations: freezed == hospitalizations ? _self._hospitalizations : hospitalizations // ignore: cast_nullable_to_non_nullable
